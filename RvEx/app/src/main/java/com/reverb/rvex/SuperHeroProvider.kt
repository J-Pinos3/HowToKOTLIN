...
class SuperHeroProvider {
    ...
    companion object{
        val superHeroList = listOf<SuperHero>(
            ...
            SuperHero("KotlinMan","JetBrains",
                "AristiDevs",
                "https://www.blogdeldia.org/wp-content/uploads/2020/12/Aristi.png"),

            SuperHero("SpiderMan","Marvel",
                "Peter Parker",
                "https://cursokotlin.com/wp-content/uploads/2017/07/spiderman.jpg"),

            SuperHero("DareDevil","Marvel",
                "Matthew Michael Murdock",
                "https://cursokotlin.com/wp-content/uploads/2017/07/daredevil.jpg"),

            SuperHero("Wolverine","Marvel",
                "James Howlett",
