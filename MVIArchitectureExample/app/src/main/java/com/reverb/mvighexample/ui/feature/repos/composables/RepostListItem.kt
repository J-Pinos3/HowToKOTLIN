    ...
    Column(
        ...
        Row(
            ...
            Column {
                ...
                Text(
                    text = repo.description ?: stringResource(id = R.string.no_description_informed),
                ...
                Text(
                    text = repo.language?.uppercase(Locale.getDefault())
                        ?: stringResource(id = R.string.language_not_defined),
                    style = MaterialTheme.typography.titleSmall
                )
...
fun CounterSession(repo: Repo){
    Row(
        ...
        CounterItem(icon = Icons.AutoMirrored.Outlined.CallSplit, counterText = repo.forksCount.toString())
    }
}
...
@Composable
fun  CounterItem(
    icon: ImageVector, counterText: String
){
    Icon(
        imageVector = icon,
    ...
    Spacer(modifier = Modifier.size(dimensionResource(id = R.dimen.padding_xxsmall)))
