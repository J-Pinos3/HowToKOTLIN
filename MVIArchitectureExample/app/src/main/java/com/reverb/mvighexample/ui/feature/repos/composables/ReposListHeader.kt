...
fun ScoreSession(userDetail: UserDetail){
    Row(
        ...
        ScoreItem(count = userDetail.publicRepos, description = stringResource(id = R.string.repos_score_title))
        ScoreItem(count = userDetail.followers, description = stringResource(id = R.string.followers_score_title))
        ScoreItem(count = userDetail.following, description = stringResource(id = R.string.following_score_title))
    }
}
...
fun ButtonsSession(userDetail: UserDetail){
    ...
    Row(modifier = Modifier.fillMaxWidth()){
        Button(onClick = {
            ...
            Text(text = stringResource(id = R.string.button_see_all_title))
        }

        Spacer(modifier = Modifier.size(dimensionResource(id = R.dimen.padding_small)))

        OutlinedButton(onClick = {
            if(userDetail.blog.isEmpty()){
            ...
            Text(text = stringResource(id = R.string.button_view_blog_title))
        }
    }
